    ...
    <div className="container mx-auto flex flex-col justify-center pb-10">
      ...
      <div className="room-infor flex flex-col p-2">
        ...
        <div className="filter-option flex flex-row justify-between">
          <button className="bg-slate shadow px-2 rounded-full">Chổ ở</button>
          <button className="bg-slate shadow px-2 rounded-full">Giá</button>
          <button className="bg-slate shadow px-2 rounded-full">Đặt ngay</button>
          <button className="bg-slate shadow px-2 rounded-full">Phòng ngủ</button>
          <button className="bg-slate shadow px-2 rounded-full">Bộ lọc khác</button>
        </div>
